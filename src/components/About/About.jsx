  ...
  return (
    <div id='about' className='h-full w-full grid grid-cols-1 md:grid-cols-[10%_90%] font-[font1]'>
      ...
      <div className="flex flex-col gap-5 items-center justify-center lg:flex-row">
        ...
        <img src={minku} className='h-[500px] mt-10 md:w-[50%] ml-2 rounded-md'/>
        ...
        <h1 className='text-3xl font-[500] text-center lg:text-start lg:mt-6'>React and Frontend Developer</h1>
          <p className='text-[1.4rem] font-[500] text-center lg:text-start text-[#27282a]'>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ut minus accusantium doloribus itaque? Voluptatem id quas consectetur, architecto molestiae nostrum?</p>
          </div>
        ...
        <SkillsCard skillImage={<FaReact className='text-[#02d0f8]'/>} skillName="REACT"/>
        <SkillsCard skillImage={<TbBrandJavascript className='text-[#f2ab3e]'/>} skillName="JavaScript"/>
        <SkillsCard skillImage={<RiTailwindCssFill className='text-[#687fef]'/>} skillName="Tailwind CSS"/>
        <SkillsCard skillImage={<FaGithub/>} skillName="GitHub"/>
        <SkillsCard skillImage={<FaCss3Alt className='text-[#016bb4]'/>} skillName="CSS"/>
        <SkillsCard skillImage={<FaHtml5 className='text-[#de4a25]'/>} skillName="HTML"/>
        </div>
          </div>
